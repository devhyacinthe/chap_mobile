class FailureMessage {
  ...
  static const logout = "Failed to logout user!";
}

class SuccessMessage {
  static const register = "Success to register user! ";
  static const login = "Success to login user! ";
  static const logout = "Success to logout user! ";
}
